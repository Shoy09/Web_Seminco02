...
export class ExcelMedicionesHorizontalService {
  ...
  exportFiltradaToExcel(datosFiltrados: MedicionesHorizontal[], fileName: string) {
    this.exportar(datosFiltrados, fileName + '_filtrado');
  }

  // Exportar toda la data completa
  exportCompletaToExcel(datosCompletos: MedicionesHorizontal[], fileName: string) {
